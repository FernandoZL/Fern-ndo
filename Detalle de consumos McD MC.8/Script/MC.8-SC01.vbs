...
session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").selectedNode = "000019"
session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").doubleClickNode "000019"
session.findById("wnd[0]").sendVKey 12
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]/usr/ctxtSL_WERKS-LOW").text = "SC01"
