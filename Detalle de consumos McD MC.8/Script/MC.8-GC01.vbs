...
session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").selectedNode = "000016"
session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").doubleClickNode "000016"
session.findById("wnd[0]").sendVKey 12
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]/usr/ctxtSL_WERKS-LOW").text = "GC01"
